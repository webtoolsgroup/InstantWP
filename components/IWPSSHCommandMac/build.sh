...
export PKG_CONFIG_PATH=$PKG_CONFIG_PATH:/usr/lib/pkgconfig:/Users/seamus/GitHub/InstantWordPress/InstantWordPress/IWPHostServ/bin/Release:/Library/Frameworks/Mono.framework/Versions/4.2.3/lib/pkgconfig
...
# Build:
mkbundle ./bin/Release/IWPSSHCommand.exe --static ./bin/Release/*.dll --deps -o ./build/IWPSSHCommand
